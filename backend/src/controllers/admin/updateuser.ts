...
export async function UpdateUserRating(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to update user rating", details: error });
  }
}
...
export async function UpdateGameResult(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to update game result", details: error });
  }
}
export async function UpdateUserBalance(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "User balance updated", user: updatedUser });
  } catch (error) {
    res
      .status(500)
      .json({ error: "Failed to update user balance", details: error });
  }
}
...
export async function SuspendUserAccount(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "User account suspended", user: updatedUser });
  } catch (error) {
    res
      .status(500)
      .json({ error: "Failed to suspend user account", details: error });
  }
}
...
export async function ActiveUserAccount(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "User account Activated", user: updatedUser });
  } catch (error) {
    res
      .status(500)
      .json({ error: "Failed to suspend user account", details: error });
...
export async function BannedUserAccount(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to ban user account", details: error });
  }
}
...
export async function MarkIssueCompleted(req: Request, res: Response) {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "Report marked as completed", report: updatedReport });
  } catch (error) {
    res
      .status(500)
      .json({ error: "Failed to update report status", details: error });
  }
}
